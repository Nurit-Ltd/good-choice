...
export function MobileSheet({
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 right-0 z-50 w-full max-w-85 sm:max-w-sm bg-[#FAF7F2] shadow-2xl transition-transform duration-300 ease-out md:hidden flex flex-col justify-between border-l border-secondary-200/60 ${
                ...
                return (
                  <div key={item.label} className="flex flex-col border-b border-secondary-200/40 pb-2">
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`w-4 h-4 text-grey-600 transition-transform duration-300 ${
                          isExpanded ? "rotate-180 text-primary-950" : ""
                        }`}
                      />
                    </button>
                      ...
                      <div className="ml-3 pl-3 border-l-2 border-primary-950/30 flex flex-col gap-4 my-2 pt-1 animate-in fade-in slide-in-from-top-1 duration-200">
                        {item.megaMenu.categories.map((cat) => (
                          <div key={cat.title} className="flex flex-col gap-1.5">
                            <span
                              className="font-heading text-sm font-semibold tracking-wide text-primary-950"
